...
####Tues. Feb 11:
  ...
  * It does appear though, in the afternoon, work did bleed over into art.   My coworkers led by Vamsi came across a data issue in transferring customer data from iseries through db2 ods into Teradata.  The iseries had an old ebcdic code page, the db2 was utf-8 and Teradata was iso-5885 or whatever.  So here,  I had to/got to read about backward the compatibility (new band) UTF affords iso codepage users..except for ctl-char.  I-series control characters are a pernicious etl tse-tse fly.  Puts ya to sleep..if you know what I mean?  The varchar length was 40 across all three platforms.  A particular row with a 40char length (awesome, I know) also had a ctl-char.(woot..)  
...
####Sun. February 22:
  ...
  * 256  bismullahs.  Should be enough.  But its cheating.  Not mapped to FDFD.  This could be partially solved with a bastard use of variation selectors!  Hack!<br>
  ...
  * Used glyphmatic.us to produce graphics for my entry into corporate naming contest for our new badass Teradata datawarehouse.  I picked "Forest" for the random forest big data algorithm.  Team members are the Owls.  Here’s my artwork.
  ...
  ![Owls](../project_images/littleowls.jpg?raw=true "Owls")  where are you owls?
